...
function InfluencerRegDetails() {
  ...
  <div className='mt-5 mt-5text-left justify-content-center align-center d-lg-mt-5'>
    <h4 className='text-center'>Welcome to Brand Sense, Ali Zafar</h4>
    ...
    <form className="needs-validation" noValidate>
      <Row>
        <Col xs={12} sm={12} md={12} lg={6}>
          ...
          <input type="text" className="form-control" id="validationTooltip01" placeholder="Ali Zafar" name="text" required style={{ borderRadius: '0', borderBottom: '1px solid black', borderLeft: 'none', borderTop: 'none', borderRight: 'none' }} />
        ...
        <Col md="4" className="mb-3">
          ...
          <input type="text" className="form-control" id="validationTooltip01" placeholder="@alizafar" name="text" required style={{ borderRadius: '0', borderBottom: '1px solid black', borderLeft: 'none', borderTop: 'none', borderRight: 'none' }} />
          <div className="valid-tooltip">
            Looks good!
          </div>
        </Col>
        ...
        <Col md="4" className="">
          ...
          <input type="text" className="form-control" id="validationTooltip01" placeholder="Signer, actor, songwriter, social worker" name="text" required style={{ borderRadius: '0', borderBottom: '1px solid black', borderLeft: 'none', borderTop: 'none', borderRight: 'none' }} />
          <div className="valid-tooltip">
            Looks good!
          </div>
        </Col>
        ...
        <Col md='4'>
          <button className="btn btn-primary" style={{ backgroundColor: '#452c63', width: '250px' }} type="button" onClick={() => onClick('InfluencerRegDetails2')}>
            Next
          </button>
        </Col>
      </Row>
