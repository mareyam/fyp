...
function EmailSent() {
  ...
  return (
    <Container fluid className="h-100">
      <Row className="h-100">
        <Col xs={12} sm={12} md={6} lg={6} className="d-flex align-items-center justify-content-center p-0 vh-100">
          ...
          <div className="mt-5 text-left justify-content-center align-center">
            ...
            <form className="needs-validation" noValidate onSubmit={handleSubmit}>
              {/* <div className="justify-content-center align-items-center text-center">
                <button className="btn btn-primary" type="submit" style={{ backgroundColor: '#452c63', width: '200px' }}>Login Page</button>
              </div> */}
            </form>
          </div>
        </Col>
